            ...
            <tbody>
              {isLoading ? (
                Array.from({ length: 8 }).map((_, index) => (
                  <tr key={`report-skeleton-${index}`} className="border-b border-border/60 dark:border-border">
                ...
                previewRows.map((row) => (
                  <tr key={row.id} className="border-b border-border/60 dark:border-border">
